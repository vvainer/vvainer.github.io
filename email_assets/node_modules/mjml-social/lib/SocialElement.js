...
var MjSocialElement = (_temp = _class = function (_BodyComponent) {
  ...
  (0, _createClass3.default)(MjSocialElement, [{
    ...
    value: function getSocialAttributes() {
      ...
      var socialNetwork = (0, _extends4.default)({}, defaultSocialNetworks[this.getAttribute('name')]);
      ...
      return ['icon-size', 'href', 'src', 'background-color'].reduce(function (r, attr) {
        return (0, _extends4.default)({}, r, (0, _defineProperty3.default)({}, attr, socialNetwork[attr] || _this2.getAttribute(attr)));
      }, {});
    }
  }, {
    key: 'render',
